...
public class ClienteProducer {
	...
	public void publishMessageEmail(Cliente cliente) {
		...
		try {
			var emailDto = new EmailDto(cliente.getId(), cliente.getEmail(), "Confirmação de cadastro",
			...
			throw new IllegalArgumentException("Erro na conexao com o broker => " + e.getMessage());
		}
	}
